    ...
    <style>{`
      * { box-sizing: border-box; }
      ...
      /* Tabulka výpůjček se na mobilu na výšku vodorovně roluje — klient
         zůstává "přilepený" vlevo, zbytek (pomůcka, data, cena, stav, akce)
         se posouvá pod ním. Na šířku (landscape) i na počítači zůstává
         tabulka úplně beze změny (border-collapse:collapse jako původně —
         se sticky nefunguje spolehlivě, proto se tu přepíná na separate). */
